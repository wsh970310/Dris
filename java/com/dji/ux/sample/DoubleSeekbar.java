...
public class DoubleSeekbar extends View {
    ...
    public DoubleSeekbar(Context context) { this(context,null); }
    ...
    public DoubleSeekbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        paintBg.setColor(getResources().getColor(R.color.yellow));
        paintBg2.setColor(getResources().getColor(R.color.gray));
    ...
    private void drawBg(Canvas canvas) {
        ...
        canvas.drawCircle(circleLeftCenterX, viewHeight / 4, bgHeight / 4, paintBg);
        canvas.drawCircle(circleRightCenterX, viewHeight / 4, bgHeight / 4, paintBg);
